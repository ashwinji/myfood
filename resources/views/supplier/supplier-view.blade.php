...
@if(Request::segment(2)==='supplier-edit' || Request::segment(2)==='add-supplier')
@if(Request::segment(2)==='add-supplier')
<?php
$id                               = '';
$name                             = '';
$mobile                           = '';
...
{{ Form::open(array('route' => 'supplier-save', 'class'=> 'form-horizontal','enctype'=>'multipart/form-data', 'files'=>true)) }}
        ...
        <div class="card-header">
            ...
            <div class="card-options">
                @if(auth()->user()->userType=='admin')
                    ...
                    <a class="btn btn-sm btn-outline-primary" href="{{ route('add-supplier') }}"> <i class="fa fa-plus"></i> Create New Supplier</a>
